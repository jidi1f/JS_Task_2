window.onload = function() {
   ...
   var str = `   Городничий. Я пригласил вас, господа, с тем чтобы сообщить вам пренеприятное известие: к нам едет ревизор.
   ...
   btn1.onclick = function(){
    ...
    for(let i = 0; i < arr.length; i++){
     ...
     if(Svalue == tmp) {text += '<p>' + " ("+i+") " + arr[i] + '</p>'};
    ...
    if(flag)
    element.remove();
    document.querySelector('body').insertAdjacentHTML('beforeend', '<div class="container">' + text + '</div>');
    flag = true;
    }
